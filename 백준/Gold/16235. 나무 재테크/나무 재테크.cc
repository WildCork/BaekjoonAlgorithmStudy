...
int main()
{
    ...
    fill(&trees[0][0][0], &trees[0][0][0] + sizeof(trees) / sizeof(trees[0][0][0]), 0);
    fill(&treesCnt[0][0], &treesCnt[0][0] + sizeof(treesCnt) / sizeof(treesCnt[0][0]), 0);
